...
type ConsumerConfig struct {
	NameSrvAddr    []string `json:"name_srv_addr" yaml:"name_srv_url"`
	GroupName      string   `json:"group_name,omitempty" yaml:"group_name"`
	ConsumerModel  int      `json:"consumer_model,omitempty" yaml:"consumer_model"`
	UseCredentials bool     `json:"use-credentials,omitempty" yaml:"use_credentials"`
	...
	ConsumerOrder  bool     `json:"consumer_order,omitempty" yaml:"consumer_order"`
}
